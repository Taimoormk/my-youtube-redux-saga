...
describe('Actions', () => {
  ...
  describe('fetchVideosAttempt', () => {
    beforeEach(() => {
      video = {};
      store.dispatch(actions.fetchVideosAttempt(video));
    });
    ...
    it('should dispatch correct type', () => {
      expect(store.getActions()[0].type).toBe(actions.fetchVideosAttempt(video).type);
    });
  });
  ...
  describe('fetchVideosSuccess', () => {
    ...
    it('should dispatch correct type', () => {
      expect(store.getActions()[0].type).toBe(actions.fetchVideosSuccess().type);
    });
  ...
  describe('getVideos', () => {
    ...
    it('should dispatch correct payload', () => {
      expect(store.getActions()[0].payload).toEqual({query, intial: undefined});
    });
  });
});